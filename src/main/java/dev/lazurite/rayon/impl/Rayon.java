...
public class Rayon {
	...
	public static void intialize() {
		...
		ServerEvents.Lifecycle.JOIN.register(player -> {
			ServerNetworking.send(player, Identifier.fromNamespaceAndPath(MODID, "i_have_rayon"), buf -> {});
		});
	}
	...
	public static void initializeClient() {
		...
		// Rayon Server Detection
		PacketRegistry.registerClientbound(Identifier.fromNamespaceAndPath(MODID, "i_have_rayon"), ctx -> serverHasRayon = true);
